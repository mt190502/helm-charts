{{- define "umami.main.image" -}}
{{- if .Values.global.postgresql.selected -}}
{{- printf "%s:postgresql-v%s" .Values.image.main.repository ((or .Values.image.main.tag .Chart.AppVersion) | toString) -}}
{{- else if .Values.global.mysql.selected -}}
{{- printf "%s:mysql-v%s" .Values.image.main.repository ((or .Values.image.main.tag .Chart.AppVersion) | toString) -}}
{{- else if .Values.image.main.tag -}}
{{- printf "%s:%s" .Values.image.main.repository ((or .Values.image.main.tag .Chart.AppVersion) | toString) -}}
{{- end -}}
{{- end -}}

{{- define "umami.postgresql.image" -}}
